...
import os
import io
from ..services import HelloRuriService, GachaRarity
...
class HelloRuri:
    """HelloRuriのDiscordコマンドインターフェース"""
    
    def __init__(self, service: HelloRuriService = None):
        self.service = service or HelloRuriService()
        self.command_name = HELLORURI_COMMAND_NAME
        self.command_description = HELLORURI_COMMAND_DESC
